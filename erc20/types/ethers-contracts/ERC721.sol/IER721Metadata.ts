...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IER721MetadataInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "getAproved" | "isApprovedForAll" | "name" | "ownerOf" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "Transfer"): EventFragment;

    encodeFunctionData(functionFragment: 'approve', values: [AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'balanceOf', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'getAproved', values: [BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'getAproved', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface IER721Metadata extends BaseContract {
    
    connect(runner?: ContractRunner | null): IER721Metadata;
    waitForDeployment(): Promise<this>;

    interface: IER721MetadataInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getAproved: TypedContractMethod<
...
getFunction(nameOrSignature: 'balanceOf'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getAproved'): TypedContractMethod<
      [tokenId: BigNumberish, ],
      [string],
      'view'
    >;
