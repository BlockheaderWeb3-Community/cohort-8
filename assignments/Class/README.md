...
> A decentralized milestone escrow application built on Ethereum — create, complete, and manage tasks entirely on-chain.

---

## Overview

## MileStoneEscrow is a simple smart contract project that demonstrates on-chain MileStone Escrow management. Built with Hardhat 3 and deployed on Ethereum
...
│   ├── MileStoneEscrow.sol            # Core todo list contract
│
│
│
├── ignition/                   # Hardhat Ignition deployment modules
│   └── modules/
│       └── MileStoneEscrow.ts         # Deployment module definitions
│
├── test/                       # Test suite
