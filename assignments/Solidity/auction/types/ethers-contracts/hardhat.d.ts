...
getContractFactory(name: 'AuctionContract', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.AuctionContract__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'AuctionContract', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.AuctionContract>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'AuctionContract', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.AuctionContract>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'AuctionContract', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.AuctionContract>
