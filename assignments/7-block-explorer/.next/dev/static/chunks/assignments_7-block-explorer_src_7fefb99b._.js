...
function BlockList(t0) {
    ...
    if ($[0] !== "2dd6da1aed31556d6ed8004ac327d8567cb0b7773d2d099190f7d858ca3bc256") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2dd6da1aed31556d6ed8004ac327d8567cb0b7773d2d099190f7d858ca3bc256";
    }
    const { blocks } = t0;
    ...
    if ($[1] !== router) {
        t1 = ({
            "BlockList[handleGoToBlock]": (blockNumber)=>{
                router.push(`/blocks/${blockNumber}`);
            }
        })["BlockList[handleGoToBlock]"];
        $[1] = router;
        $[2] = t1;
    } else {
        t1 = $[2];
    }
    const handleGoToBlock = t1;
    let t2;
    if ($[3] !== blocks || $[4] !== handleGoToBlock) {
        t2 = blocks?.map({
            "BlockList[(anonymous)()]": (bl)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                onClick: {
                                                    "BlockList[(anonymous)() > <p>.onClick]": ()=>handleGoToBlock((0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hexToDecimal"])(bl.number))
                                                }["BlockList[(anonymous)() > <p>.onClick]"],
...
_s(BlockList, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
...
function useEthereumStats() {
    ...
    if ($[0] !== "2abf1eebb03a6e9da9985a90fd0d5b4ce471a2d1c2d05fb0cef6feb921e8bd90") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2abf1eebb03a6e9da9985a90fd0d5b4ce471a2d1c2d05fb0cef6feb921e8bd90";
    }
    let t0;
...
function StatsGrid(t0) {
    ...
    if ($[0] !== "8ea1b2a360cf4368fa498ff2e6bf9e881bc5c40ba60ee57d6dcdb1c5943e8809") {
        for(let $i = 0; $i < 15; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8ea1b2a360cf4368fa498ff2e6bf9e881bc5c40ba60ee57d6dcdb1c5943e8809";
    }
...
function TransactionList(t0) {
    ...
    if ($[0] !== "a06e646a21018cde6eb20e1b3e90233fb67de11cad94c2cda784269728d9bf71") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a06e646a21018cde6eb20e1b3e90233fb67de11cad94c2cda784269728d9bf71";
    }
    const { transactions } = t0;
    let t1;
    if ($[1] !== transactions) {
        t1 = transactions.map(_TransactionListTransactionsMap);
        $[1] = transactions;
        $[2] = t1;
    } else {
        t1 = $[2];
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hexToDecimal"])(tx.value) / 1000000000000000000,
                        " ETH"
                    ]
                }, void 0, true, {
                    fileName: "[project]/assignments/7-block-explorer/src/components/TransactionList.tsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hexToDecimal"])(tx.gasPrice) / 1000000000,
                        " Gwei"
                    ]
                }, void 0, true, {
                    fileName: "[project]/assignments/7-block-explorer/src/components/TransactionList.tsx",
...
"[project]/assignments/7-block-explorer/src/lib/useTransaction.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useTransaction = ()=>{
    ...
    const [recentBlocks, setRecentBlocks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [finalizedBlockNumber, setFinalizedBlockNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [safeBlockNumber, setSafeBlockNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleGetSafeBlockNumber = async ()=>{
        const blockData_1 = await fetchBlockByNumber({
            method: __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$constant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ETH_GET_BLOCK_BY_NUMBER"],
            params: [
                'safe',
                true
        ...
        setSafeBlockNumber((0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hexToDecimal"])(blockData_1?.result?.number));
    };
...
_s(useTransaction, "yMvXTE7hdaPRvcpuaNE7BElJcIo=", true, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$useTransaction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/assignments/7-block-explorer/src/lib/useTransaction.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function HomePage() {
    ...
    if ($[0] !== "3db536588c94a44d4d868cc07267ae07d28cb81113a5e193154f96c75ca48a60") {
        for(let $i = 0; $i < 19; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3db536588c94a44d4d868cc07267ae07d28cb81113a5e193154f96c75ca48a60";
    }
    const { transactions, transactionsLoading, blocks, blocksLoading, finalizedBlockNumber, safeBlockNumber } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$useTransaction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
_s(HomePage, "sR5YA2tj3d2PoI4Fd4XpCkRTyxU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$useTransaction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
_c = HomePage;
...
//# sourceMappingURL=assignments_7-block-explorer_src_7fefb99b._.js.map