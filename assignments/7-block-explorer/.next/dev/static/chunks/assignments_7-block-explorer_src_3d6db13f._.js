...
const useTransaction = ()=>{
    ...
    const handleFetchBlockNumber = async ()=>{
        ...
        console.log('Block Number Data:', data);
        console.log('Last Block Number:', (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hexToDecimal"])(data?.result));
    };
...
_s(useTransaction, "g4GDjQ5YcNhRaf8jRBn2jChHTuE=", true, function() {
    return [
...
//# sourceMappingURL=assignments_7-block-explorer_src_3d6db13f._.js.map