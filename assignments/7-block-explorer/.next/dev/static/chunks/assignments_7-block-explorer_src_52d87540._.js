...
function BlockList(t0) {
    ...
    if ($[0] !== "3b3d4b76722f71c74ba3bbdd391d294cd2669e83436bda86d386c6bf5d32dd80") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3b3d4b76722f71c74ba3bbdd391d294cd2669e83436bda86d386c6bf5d32dd80";
    }
    const { blocks } = t0;
...
_s(useTransaction, "c9jhJJryCoVbJ+jZaj3oubcej5g=", true, function() {
    return [
...
function HomePage() {
    ...
    if ($[0] !== "a112c466b5d77cb1b43798f2417ce3352c9f00396c7402f7506c44e438370a6b") {
        for(let $i = 0; $i < 24; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a112c466b5d77cb1b43798f2417ce3352c9f00396c7402f7506c44e438370a6b";
    }
    ...
    const { transactions, transactionsLoading, blocks, blocksLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$api$2f$useTransaction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
_s(HomePage, "S2Hi1h82smpoCyWuIEk8Zgjidbs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$assignments$2f$7$2d$block$2d$explorer$2f$src$2f$lib$2f$useEtherscanData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEthereumStats"],
...
//# sourceMappingURL=assignments_7-block-explorer_src_52d87540._.js.map