...
> A decentralized Timelock application that locks value for a certain time .

---

## Overview

TodoList is a simple smart contract project that demostrate a timelock savings mechanism.
...
| Contract   | Address                                    | Etherscan                                                                                                  |
| ---------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| `TodoList` | 0xF813aa565B3af9f59DdB89F863B8fffB9E620747 | [View on Etherscan] (https://sepolia.etherscan.io/address/0xF813aa565B3af9f59DdB89F863B8fffB9E620747#code) |
